...
CoreSystem::CoreSystem()
{
	...
	lux::core->SystemMessage(SYSTEM_MESSAGE_LOG) << __FUNCTION__ << ": Found '" << found << "' Wiimote(s). " << connected << " are conected." << std::endl;
...
void CoreSystem::AbleOutput(bool able)
{
	if ( able )
	{
		...
		//lux::core->SystemMessage(SYSTEM_MESSAGE_LOG).sync_with_stdio(true);
		...
		//lux::core->SystemMessage(SYSTEM_MESSAGE_LOG).sync_with_stdio(false);
		lux::core->SystemMessage(SYSTEM_MESSAGE_LOG) << "-------------------------------------" << std::endl;
		lux::core->SystemMessage(SYSTEM_MESSAGE_LOG) << PROGRAM_NAME << " - Version " << PROGRAM_VERSION << std::endl;
		lux::core->SystemMessage(SYSTEM_MESSAGE_LOG) << "-------------------------------------" << std::endl;
