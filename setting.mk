...
#Compiler
COMPILER_LIBS= $(OPTIMIZER) $(DEBUG) -L'./lib' $(LDFLAGS)
COMPILER_FLAGS+= $(OPTIMIZER) $(DEBUG) -I'./src/libs' -I'src' -I'./include' $(CFLAGS)
COMPILER_FLAGSPP+= $(OPTIMIZER) $(DEBUG) -I'./src/libs' -I'src' -I'./include' -Wno-write-strings -fno-access-control -fno-exceptions -fno-rtti $(CPPFLAGS)
